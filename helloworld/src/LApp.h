...
int PrintData(u8);					// Print Data to the Terminal Window
void PrintBinBytes(u32, u8);		// Print integers as sequence of binary char bytes
int PrintWFData();					// Print WFs out to the Terminal Window
...
int PrintDataSingleCol( void );
int EncodePrint(unsigned int outWord, int printTab);	//send tab separated data using the encoding method - GJS 02/25/2019
#endif /* LAPP_H_ */
